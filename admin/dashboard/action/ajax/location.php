        ...
        $getLocation = $conn->query("SELECT * from location");
            ...
            $output .= '
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-'.$color .' invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div class="d-grid">
                                <span class="text-white fs-18">'.$location['address'].'</span>
                                <button type="button" onclick="updateLocation(this)" id="'.$location['location_id'].'" class="btn btn-'.$color.' d-block btn-sm" '.$dis .'>'.$stat .'</button>';
