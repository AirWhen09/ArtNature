        ...
        <div class="col-xl-12 col-xxl-12">
            ...
            ?>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-<?php echo $color ?> invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div class="d-grid">
                                <span class="text-white fs-18"><?php echo $location['address']?></span>
                                <button type="button" onclick="updateLocation(this)" id="<?php echo $location['location_id']?>" class="btn btn-<?php echo $color ?> d-block btn-sm" <?php echo $dis ?>><?php echo $stat ?></button>
                                <?php 
                                if($stat == "ACTIVE"){
                                    ?>
                                        <span class="text-white fs-10">You arrived at <b><?php echo date('F d, Y h:mA', strtotime($dateTime))?></b></span>
