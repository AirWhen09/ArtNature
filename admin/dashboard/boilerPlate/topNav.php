<?php
    if(isset($_SESSION['user_role'])){
        ...
        if($getCountNotif){
            $notifNo = $getCountNotif['myNotif'];
            if($notifNo < 1) $notifNo = '';
        }else{
            $notifNo = '';
        }
    }else{
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" id="notifID" data-bs-toggle="dropdown" aria-haspopup="true">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="index.php?chat">
                                 <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="badge light text-white bg-primary rounded-circle"><?php echo $msgNo ?></span>
                                </a>
							</li>
                            <!-- <li class="nav-item">
